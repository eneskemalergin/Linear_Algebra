...
first_of_tuples_list =  first_of_tuples_list = [(x, y, z) for x in S for y in S for z in S if x+y+z == 0 and (x, y, z) != (0, 0, 0)][0]
...
_list_ = ['A','B','C','D','E']
range_and_zip = list(zip (range(5), _list_))
...
value_list = value_list = [x[k] for x in dlist]
